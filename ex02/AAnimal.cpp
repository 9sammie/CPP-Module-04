...
/*   Updated: 2026/01/06 14:18:42 by maballet         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
// deep copy with new Brain de *other._brain.
// That way we now point on this new brain instead of the one already created by AAnimal.
...
// deep copy with _brain = new Brain de *other._brain.
// That way we now point on this new brain instead of the one already created by AAnimal.
AAnimal& AAnimal::operator = ( const AAnimal& other ) {
	...
	if (this != &other) {
		_type = other._type;
		delete _brain;					   // if a brain already exist
